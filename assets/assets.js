...
export const BagIcon = () => {
  return (
    <svg
      ...
      fill="currentColor"      // <- use fill for solid color icons
      viewBox="0 0 24 24"
      aria-hidden="true"
    >
      <path
        fill="currentColor"    // <- ensure path uses currentColor
        d="M9 10V6a3 3 0 0 1 3-3 3 3 0 0 1 3 3v4m3-2 .917 11.923A1 1 0 0 1 17.92 21H6.08a1 1 0 0 1-.997-1.077L6 8h12Z"
      />
    </svg>
  );
};
